...
public class CenterAuto extends SequentialCommandGroup {
    ...
    public CenterAuto(DriveSubsystem drive, IntakeSubsystem intake, ConveyorSubsystem conveyor, ShooterSubsystem shooter,
            ...
            addCommands(
                            ...
                            new DropIntakeDelay(intake, IntakeConstants.kIntakeDropSpeed,
                                            IntakeConstants.kIntakeDropTime),
    ...
    public Pose2d getPose() {
            return m_trajectories.getCenterPickUp().getInitialPose();
    }
}
